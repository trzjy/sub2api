...
class XYAccount(TimestampMixin, Base):
    ...
    proxy_host: Mapped[str | None] = mapped_column(String(255), comment="代理主机")
    ...
    reply_delay_seconds: Mapped[int] = mapped_column(Integer, default=0, comment="自动回复延迟时间(秒)，0表示立即回复")
