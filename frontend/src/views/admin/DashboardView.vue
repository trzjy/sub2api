              ...
              <div>
                ...
                <p class="text-xs">
                  <span
                    ...
                    >{{ currencySymbol(ACCOUNT_CURRENCY) }}{{ formatCost(stats.today_actual_cost) }}</span
                  >
                  <span class="text-gray-400 dark:text-gray-500"> / </span>
                  <span
                    class="text-orange-500 dark:text-orange-400"
                    :title="t('admin.dashboard.accountCost')"
                    >{{ currencySymbol(ACCOUNT_CURRENCY) }}{{ formatCost(stats.today_account_cost) }}</span
                  >
                  <span class="text-gray-400 dark:text-gray-500"> / </span>
                  <span
                    class="text-gray-400 dark:text-gray-500"
                    :title="t('admin.dashboard.standard')"
                    >{{ currencySymbol(ACCOUNT_CURRENCY) }}{{ formatCost(stats.today_cost) }}</span
                  >
                </p>
              </div>
            </div>
              ...
              <div>
                ...
                <p class="text-xs">
                  <span
                    class="text-green-600 dark:text-green-400"
                    :title="t('admin.dashboard.actual')"
                    >{{ currencySymbol(ACCOUNT_CURRENCY) }}{{ formatCost(stats.total_actual_cost) }}</span
                  >
                  <span class="text-gray-400 dark:text-gray-500"> / </span>
                  <span
                    class="text-orange-500 dark:text-orange-400"
                    :title="t('admin.dashboard.accountCost')"
                    >{{ currencySymbol(ACCOUNT_CURRENCY) }}{{ formatCost(stats.total_account_cost) }}</span
                  >
                  <span class="text-gray-400 dark:text-gray-500"> / </span>
                  <span
                    class="text-gray-400 dark:text-gray-500"
                    :title="t('admin.dashboard.standard')"
                    >{{ currencySymbol(ACCOUNT_CURRENCY) }}{{ formatCost(stats.total_cost) }}</span
                  >
                </p>
              </div>
            </div>
