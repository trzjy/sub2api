export default {
  ...
  payment: {
    ...
    rechargeRatePreview: '按汇率 1 USD ≈ {fx} {currency}，到账金额 = 实付 ÷ 汇率',
    refundReason: '退款原因',
    ...
    admin: {
      ...
      currencyHintStoredUsd: '输入为 CNY；保存后按当前汇率换算并存储 USD',
      planPriceCny: '价格（CNY）',
      planOriginalPriceCny: '原价（CNY）',
      storedUsdPreview: '存储 USD 预览：{amount}',
      validity: '有效期',
      validityUnit: '有效期单位',
      sortOrder: '排序',
      forSale: '上架状态',
