export default {
    ...
    users: {
      ...
      subscriptionFilter: '生效订阅',
      allSubscriptions: '全部订阅',
      hasActiveSubscription: '有生效订阅',
      noActiveSubscription: '无生效订阅',
    ...
    groups: {
      ...
      form: {
        ...
        concurrencyLimit: '订阅分组并发上限',
        concurrencyLimitPlaceholder: '0 表示不限制',
        concurrencyLimitHint: '仅订阅分组生效：限制每个使用者各自的并发请求数（非分组总并发）；0 = 不限制',
