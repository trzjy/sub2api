export default {
    ...
    redeem: {
      ...
      deleteSelected: '删除所选',
      deleteSelectedConfirm: '确定要删除已选中的 {count} 个兑换码吗？此操作无法撤销。',
      selectedCodesDeleted: '成功删除 {count} 个兑换码',
      failedToDeleteSelected: '删除所选兑换码失败',
      batchFields: {
        status: '状态',
        expiresAt: '过期时间',
        notes: '备注',
      ...
      expireAction: '作废',
      expireCode: '作废兑换码',
      expireCodeConfirm: '确定要作废此兑换码吗？作废后买家将无法兑换，此操作无法撤销。',
      codeExpired: '兑换码已作废',
      failedToExpire: '作废兑换码失败',
