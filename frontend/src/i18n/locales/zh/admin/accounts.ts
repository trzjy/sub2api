export default {
    accounts: {
      ...
      webLogin: {
        ...
        iframeTitle: '官方登录页（内嵌）',
        iframeHint: '在下方内嵌页面完成登录，随后复制 Cookie 粘贴到输入框（内嵌页 Cookie 无法自动读取）。',
        iframeBlockedHint: '官方登录页可能禁止内嵌展示（X-Frame-Options），请点击「重新加载」重试，或直接在新窗口登录后手动粘贴 Cookie。',
        reload: '重新加载',
