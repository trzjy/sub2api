export default {
    accounts: {
      ...
      webProviders: {
        ...
        renewalEmailLabel: '续期邮箱',
        renewalEmailPlaceholder: '登录官方网页端所用的邮箱',
        renewalPasswordLabel: '续期密码',
        renewalPasswordPlaceholder: '登录官方网页端所用的密码（留空保留原值）',
        errors: {
          webCookieRequired: '网页账号缺少登录凭证：请先完成自动登录',
          webKimiAccessTokenRequired: 'Kimi 网页账号仅支持短信登录创建（access_token 由后端自动取得）',
        },
      },
      webLogin: {
        autoLogin: {
          title: '使用账号密码自动登录',
          titleSms: '使用手机号 + 短信验证码自动登录',
          deepseekHint: 'DeepSeek 网页端使用账号密码登录后将直接返回 Cookie 并自动回填。',
          zhipuKimiHint: '智谱 / Kimi 网页端登录使用手机号 + 短信验证码：点击下方获取验证码，按提示完成验证后提交。',
          emailLabel: '登录邮箱',
          ...
          smsSendCode: '获取验证码',
          smsSending: '发送中…',
          smsCodeSent: '验证码已发送，请查收短信并输入',
          sendCodeFailed: '获取验证码失败，请重试',
          success: '自动登录成功，已回填登录态',
          smsLoginSuccess: '短信登录成功，账号已创建 / 绑定',
          challengeSectionTitle: '人机验证回传',
          zhipuCaptchaRidLabel: '数美滑块 rid',
          zhipuCaptchaMd5Label: '图形校验 md5',
          zhipuPhoneCodeLabel: '手机区号',
          zhipuPhoneCodePlaceholder: '86',
          kimiCaptchaValidateLabel: '易盾 validate',
          smsChallengeWaiting: '请在浏览器完成滑块/验证码，将回传值（rid/md5 或 validate）填入上方挑战字段后重试',
          smsChallengeRetry: '挑战未完成或超时：可重试获取验证码或重新提交短信码',
          ...
          captchaWidgetTitle: '人机验证',
          captchaHintZhipu: '拖动下方数美滑块完成验证，验证通过后将自动发送短信码。',
          captchaHintKimi: '点击「完成易盾验证」弹出滑块，验证通过后自动发送短信码。',
          captchaLaunchKimi: '完成易盾验证',
          captchaSolvedZhipu: '数美滑块验证已通过，正在发送短信码',
          captchaSolvedKimi: '易盾验证已通过，正在发送短信码',
          captchaLoadFailed: '验证码组件加载失败，已切换为手动填写',
          captchaWaitZhipu: '请先拖动完成数美滑块验证',
          manualFallbackToggle: '验证码无法加载？点此手动填写',
        },
      },
      cnProviders: {
        accountMode: {
