    ...
    accounts: {
      ...
      webLogin: {
        autoLogin: {
          ...
          deepseekHint: 'DeepSeek 网页端使用邮箱和密码登录，验证成功后系统自动创建账号。',
        ...
        register: {
          modeToggle: '邮箱注册',
          modeTogglePassword: '密码登录',
          emailLabel: '注册邮箱',
          emailPlaceholder: '用于注册 DeepSeek 账号的邮箱',
          emailRequired: '请填写注册邮箱',
          emailInvalid: '邮箱格式不正确',
          sendCode: '发送验证码',
          sendCodeSending: '发送中…',
          codeSentHint: '验证邮件已发送，请查收（含垃圾邮件箱）；{secs} 秒后可重新发送',
          codeSentHintNoWindow: '验证邮件已发送，请查收（含垃圾邮件箱）',
          sendCodeFailed: '发送验证码失败，请重试',
          codeLabel: '邮箱验证码',
          codePlaceholder: '输入收到的 6 位邮箱验证码',
          codeRequired: '请填写邮箱验证码',
          codeInvalid: '验证码为 6 位数字',
          passwordLabel: '设置密码',
          passwordPlaceholder: '注册账号所用密码',
          passwordRequired: '请填写注册密码',
          passwordRuleHint: '密码需至少 8 位且同时包含字母和数字',
          passwordWeak: '密码强度不足：需至少 8 位且同时包含字母和数字',
          submit: '注册并创建账号',
          submitting: '注册中…',
          registerFailed: '注册失败，请重试',
          errorRecaptcha: '上游要求人机验证，请改用密码登录入口或稍后再试',
          errorEmailDomain: '该邮箱域不受支持，请更换邮箱后重试',
          errorRegisteredUsePasswordLogin: '账号已在 DeepSeek 注册成功，请使用邮箱+密码在『密码登录』入口完成创建',
        },
      },
      cnProviders: {
        accountMode: {
