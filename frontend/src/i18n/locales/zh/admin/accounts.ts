export default {
    accounts: {
      ...
      webProviders: {
        ...
        riskWarning: {
          title: '封号风险提示：此功能使用官方网页端逆向转发，违反平台用户协议',
          body: '该账号会参与站点调度，请使用可接受风险的账号；网页免费额度无稳定性承诺，平台不对此提供担保。',
        },
        cookieLabel: '整串 Cookie',
        cookiePlaceholder: '粘贴登录后的完整 Cookie 请求头内容',
        cookieHint: '登录官方网页端后，从浏览器请求中复制整串 Cookie（含全部字段）。',
        kimiTokenLabel: 'Token JSON',
        kimiTokenPlaceholder: "{'{'}\"access_token\":\"...\",\"refresh_token\":\"...\",\"user_id\":\"...\"{'}'}",
        kimiTokenHint: '登录 www.kimi.com 后，从浏览器本地存储复制 access_token / refresh_token / user_id 并按左侧 JSON 格式粘贴（仅 access_token 必填）。',
        baseUrlLabel: '官方域名覆盖（可选）',
        baseUrlPlaceholder: 'https://chat.deepseek.com',
        baseUrlHint: '留空使用默认官方域名；仅在需要显式指定入口域名时填写。',
        errors: {
      ...
      webLogin: {
        ...
        platformHint: {
          ...
          kimi: '登录页经本站代理内嵌展示；Token 无法自动捕获，登录后请从本地存储复制 Token JSON，手动粘贴到下方输入框。',
        },
        proxyTitle: '登录代理（自动捕获 Cookie）',
        proxyUnavailable: '登录代理不可用，请在官方页面登录后手动粘贴',
        autoCapturing: '正在自动捕获登录 Cookie…',
        autoCaptureSuccess: '已自动填入登录 Cookie，正在校验',
        autoCaptureTimeout: '自动捕获超时，请手动粘贴',
        pasteHint: '校验仅确认凭证格式；真实可用性在首次转发时验证。',
        apply: '校验并回填',
        validationFailed: '凭证校验未通过：请检查格式后重试',
        tabs: {
          capture: 'Cookie 捕获',
          auto: '自动登录',
        },
        autoLogin: {
          title: '使用账号密码自动登录',
          deepseekHint: 'DeepSeek 网页端使用账号密码登录后将直接返回 Cookie 并自动回填。',
          zhipuKimiHint: '智谱 / Kimi 网页端登录需短信验证；当前短信发码通道尚未接入，请改用「Cookie 捕获」手动粘贴登录态。',
          emailLabel: '登录邮箱',
          emailPlaceholder: '登录官方网页端所用的邮箱',
          phoneLabel: '手机号',
          ...
          loginFailed: '自动登录失败，请检查账号密码后重试',
          smsStepTitle: '已发送短信验证码，请输入以完成登录',
          smsCodeLabel: '短信验证码',
          smsCodePlaceholder: '输入收到的短信验证码',
          smsSubmit: '提交验证码',
          smsCodeRequired: '请填写短信验证码',
          smsNotConnected: '短信码登录尚未接入发码通道，无法完成自动登录',
        },
      },
      cnProviders: {
        accountMode: {
      ...
      loginStatus: {
        active: '正常',
        failed: '失效',
        failedTitle: '账号登录态失效，可重试自动登录',
        failedTitleWithDetail: '账号登录态失效：{detail}',
        banned: '封禁',
        bannedTitle: '账号已被封禁',
      ...
      batch: {
        ...
        test: '一键测试',
        deleteBanned: '删除封禁账号',
        deleteBannedConfirm: '确认删除以下 {count} 个封禁账号吗？此操作不可恢复：{names}',
        deleteBannedNone: '没有可删除的封禁账号',
        enable: '批量启用',
        disable: '批量停用',
        export: '导出 Web 清单',
        exportSuccess: 'Web 账号清单已导出',
        loginSuccess: '一键登录完成：成功 {success} 个，失败 {failed} 个，需短信 {needsSms} 个',
        loginPartial: '一键登录部分完成：成功 {success} 个，失败 {failed} 个，需短信 {needsSms} 个',
        loginFailed: '一键登录失败',
        testSuccess: '一键测试完成：成功 {success} 个，失败 {failed} 个',
        testPartial: '一键测试部分完成：成功 {success} 个，失败 {failed} 个',
        testFailed: '一键测试失败',
        deleteBannedSuccess: '已删除 {count} 个封禁账号',
        deleteBannedFailed: '删除封禁账号失败',
        statusSuccess: '已更新 {count} 个账号状态',
        statusPartial: '批量设置状态部分完成：成功 {success} 个，失败 {failed} 个',
        statusFailed: '批量设置账号状态失败',
        exportFailed: '导出 Web 账号清单失败',
        noSelection: '请先选择账号',
        selectWebOnly: '请选择网页接入（web）平台的账号',
      },
      bulkEdit: {
        title: '批量编辑账号',
      ...
      codeBuddyWizard: '模型与二级账号',
      codeBuddyWizardTitle: 'CodeBuddy 上游模型与二级账号',
      codeBuddyWizardOpen: '为「{name}」管理上游模型与二级账号',
      codeBuddyUnsyncedGuide: '尚未同步上游模型。先同步 CodeBuddy 上游模型清单，再为每个模型创建二级账号。',
      codeBuddySyncModels: '同步上游模型',
      codeBuddySyncing: '正在同步上游模型…',
      codeBuddySyncFailed: '同步上游模型失败：{error}',
      codeBuddySyncSuccess: '已同步 {count} 个上游模型',
      codeBuddyIntlUnavailable: '该账号为国际版站点，模型同步在 intl 端点不可用（实测 HTTP 500），无法创建二级账号。',
      codeBuddySelectAll: '全选',
      codeBuddyDeselectAll: '取消全选',
      codeBuddyColModel: '模型',
      codeBuddyColContext: '上下文',
      codeBuddyColMaxOutput: '最大输出',
      codeBuddyColPrice: '官方价',
      codeBuddyColPlatform: '目标平台',
      codeBuddyColGroup: '目标分组',
      codeBuddyColPriority: '优先级',
      codeBuddyColStatus: '影子状态',
      codeBuddyStatusCreated: '已创建',
      codeBuddyStatusNotCreated: '未创建',
      codeBuddyStatusPartial: '已创建 {done}/{total}',
      codeBuddyGroupUnselected: '未选分组',
      codeBuddyAddGroup: '添加分组',
      ...
      codeBuddyParentCreditLabel: '母账号余额',
      codeBuddyLegacyName: '存量命名',
      codeBuddyLegacyNameHint: '该影子名不含站点标识（存量数据）。可在「编辑账号」中按 <母账号名>:<站点>:<模型> 改名，不强制。',
      codeBuddyBatchCreate: '批量创建二级账号',
      codeBuddyCreating: '正在创建…',
      codeBuddyBatchCreateSuccess: '成功创建 {count} 个二级账号',
      codeBuddyBatchCreatePartial: '创建完成：成功 {success} 个，失败 {failed} 个',
      codeBuddyBatchCreateFailed: '批量创建失败：{error}',
      codeBuddyNoSelection: '请至少勾选一个未创建的模型',
      codeBuddyGroupRequired: '模型「{model}」需选择目标分组',
      codeBuddyParentBadge: '上游',
      codeBuddyShadowBadge: '影子',
      codeBuddyJumpParent: '查看母账号',
      codeBuddyDeleteBlocked: '该账号存在 {count} 个活跃二级账号，请先删除或处理这些二级账号后再删除母账号。',
      codeBuddyConfigurePriceHint: '影子账号定价在创建后于账号或分组维度配置',
      ...
      syncUpstreamModelsSuccess: '已从上游同步 {count} 个新模型（平台相关共 {total} 个）',
      syncUpstreamModelsNoChanges: '上游 {count} 个模型均已在白名单中',
      syncUpstreamModelsEmpty: '上游没有返回可同步的模型',
      syncUpstreamModelsPlatformFiltered: '已按账号平台过滤 {count} 个无关模型（未自动加入，可在下拉中手动添加）',
      ...
      syncVolcanoPlanRequiresAccount: '火山订阅号模型同步需要已保存的账号。',
      syncVolcanoPlanWillAdd: '{count} 个新确认模型将被加入',
      syncVolcanoPlanWillRemove: '{count} 个官方下线模型将被替换移除',
      syncVolcanoPlanFullConfirm: '本次为完整确认：将按官方套餐收敛（替换为最新集合）',
      syncVolcanoPlanPartialConfirm: '部分模型未确认：将只新增、不删除既有模型',
      ...
      otherBaseUrlRequired: '通用自定义上游（Other）必须填写自定义 Base URL',
