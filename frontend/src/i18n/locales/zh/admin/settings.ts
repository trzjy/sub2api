export default {
    settings: {
      ...
      defaults: {
        ...
        codebuddyDefaultRpm: 'CodeBuddy 默认 RPM 限制',
        codebuddyDefaultRpmHint: 'CodeBuddy 账号未单独配置「基础 RPM」时的平台默认值，0 = 关闭平台默认；用于防止漏配账号被上游风控',
      ...
      site: {
        ...
        footerLinks: {
          title: '友情链接',
          description: '配置首页底部展示的友情链接（换链/上链无需发版）。所有通过校验的链接将按排序全量展示。',
          name: '名称',
          namePlaceholder: '如：AI API中转站评测',
          url: '链接地址',
        ...
        siteLogo: '站点Logo',
        supportQrcode: '客服二维码(微信群)',
        supportQrcodeHint: '展示在页面右下角客服浮窗中,建议小于 1MB 的群二维码图片',
        supportQrcodePlaceholder: '粘贴图片 URL 或直接上传',
        uploadImage: '上传图片',
        remove: '移除',
        ...
        concurrencyLimitMessage: '并发超限提示文案',
        concurrencyLimitMessagePlaceholder: '当前{scope}并发上限 {limit}，已达上限值。',
        concurrencyLimitMessageHint:
          '留空则使用系统默认英文文案。支持变量：{scope} 会被替换为「用户」或「订阅」，{limit} 会被替换为并发上限数值（为 0 时回退英文）。仅作用于用户与订阅分组两个维度，上游账号维度不受影响。',
        compactHome: '简洁首页',
      ...
      payment: {
        ...
        dailyLimit: '每日限额',
        fxRatesTitle: '全局汇率表',
        fxRatesHint: '语义：1 USD = X <币种>。USD 隐含 1.0 不写入；CNY 必填。已启用支付渠道的币种必须存在于表内，否则无法保存。',
        fxRatesCnyRequired: 'CNY 汇率必填',
        fxRatesMissingChannel: '以下已启用渠道币种尚未配置汇率：{currencies}',
        fxRatesAdd: '添加币种',
        fxRatesCurrency: '币种',
        fxRatesRate: '汇率',
        fxRatesRemove: '删除',
        fxRatesRemoveConfirm: '确定删除 {currency} 汇率？',
        rechargeFeeRate: '充值手续费率',
        rechargeFeeRateHint: '用户充值时额外收取的手续费百分比，0 表示不收取手续费',
        rechargeFeePreview: '预览：充值 100 {currency}，手续费 {fee} {currency}',
        orderTimeout: '订单超时时间',
        ...
        field_xunhupayApiBaseHint: '虎皮椒支付网关，默认 https://api.xunhupay.com；以虎皮椒后台「我的支付渠道」显示为准。',
        ...
        field_paymentCurrencyHint: '默认 CNY。Stripe 和 Airwallex 可按账户支持从下拉项选择 HKD、USD 等币种；微信、支付宝、易支付仍按 CNY。所选币种必须已配置全局汇率（见上方"全局汇率表"）。',
