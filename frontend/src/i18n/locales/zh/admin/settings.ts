export default {
    settings: {
      ...
      payment: {
        ...
        maxAmount: '最高金额',
        dailyLimit: '每日限额',
        balanceRechargeMultiplier: '充值加价系数',
        balanceRechargeMultiplierHint: '汇率平价之上的加价系数：到账 USD = ToUSD(实付, 支付币种) × 系数，1.0 = 按汇率平价入账',
        balanceRechargePreview: '预览：1 USD ≈ {fx} {currency}，加价 {markup}×',
        fxRatesTitle: '全局汇率表',
