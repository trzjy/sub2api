export default {
  common: {
    ...
    vsOfficialHint: 'Paid unit price ÷ official API reference (avg of group model input prices, indicative)',
    vsOfficial: 'vs official',
    vsOfficialTitle: 'Cheaper than official API',
  ...
  nav: {
    ...
    xianyuDelivery: 'Xianyu Delivery',
    xianyuOverview: 'Overview',
    xianyuAccounts: 'Accounts',
    xianyuProducts: 'Products & Binding',
