export default {
    settings: {
      ...
      payment: {
        ...
        balanceRechargeMultiplier: 'Recharge Markup',
        balanceRechargeMultiplierHint: 'Markup over FX rate: credited USD = ToUSD(paid, currency) × markup. 1.0 = flat FX rate.',
        balanceRechargePreview: 'Preview: 1 USD ≈ {fx} {currency}, markup {markup}×',
