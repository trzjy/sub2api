export default {
    settings: {
      ...
      site: {
        ...
        footerLinks: {
          title: 'Footer Links',
          description: 'Configure footer links shown at the bottom of the home page (swap/add links without redeploying). All validated links are displayed in full by sort order.',
          name: 'Name',
          namePlaceholder: 'e.g., AI API Gateway Review',
          url: 'URL',
        ...
        siteLogo: 'Site Logo',
        supportQrcode: 'Support QR Code (WeChat group)',
        supportQrcodeHint: 'Shown in the floating support widget at the bottom-right; WeChat group QR image under 1MB recommended',
        supportQrcodePlaceholder: 'Paste an image URL or upload directly',
      ...
      payment: {
        ...
        fxRatesTitle: 'Global FX Rates Table',
        fxRatesHint: 'Semantic: 1 USD = X <currency>. USD is implied 1.0 and not stored. CNY is required. Enabled payment channel currencies must exist in this table or saving will be rejected.',
        fxRatesCnyRequired: 'CNY rate is required',
        fxRatesMissingChannel: 'The following enabled channel currencies have no FX rate configured: {currencies}',
        fxRatesAdd: 'Add currency',
        fxRatesCurrency: 'Currency',
        fxRatesRate: 'Rate',
        fxRatesRemove: 'Remove',
        fxRatesRemoveConfirm: 'Remove FX rate for {currency}?',
        ...
        rechargeFeePreview: 'Preview: Recharge 100 {currency}, fee {fee} {currency}',
        ...
        field_xunhupayApiBaseHint: 'XunhuPay payment gateway, defaults to https://api.xunhupay.com; use the gateway shown in the XunhuPay merchant dashboard.',
        ...
        field_paymentCurrencyHint: 'Default is CNY. Stripe and Airwallex can choose HKD, USD, or another listed currency supported by the account; WeChat Pay, Alipay, and EasyPay remain CNY. The selected currency must have a global FX rate configured (see "Global FX Rates Table" above).',
