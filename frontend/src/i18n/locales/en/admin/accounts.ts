export default {
    accounts: {
      ...
      webProviders: {
        ...
        riskWarning: {
          title: 'Ban risk warning: this feature forwards via reverse-engineered official web clients, which violates platform terms',
          body: 'This account will participate in site scheduling; only use an account whose risk you accept. Free web quota carries no stability guarantee.',
        },
        cookieLabel: 'Full Cookie String',
        cookiePlaceholder: 'Paste the complete Cookie request header captured after login',
        cookieHint: 'Log in to the official web client, then copy the entire Cookie header (all fields) from a browser request.',
        kimiTokenLabel: 'Token JSON',
        kimiTokenPlaceholder: "{'{'}\"access_token\":\"...\",\"refresh_token\":\"...\",\"user_id\":\"...\"{'}'}",
        kimiTokenHint: 'Log in to www.kimi.com, copy access_token / refresh_token / user_id from local storage, and paste as JSON (only access_token is required).',
        baseUrlLabel: 'Official Domain Override (optional)',
        baseUrlPlaceholder: 'https://chat.deepseek.com',
        baseUrlHint: 'Leave empty to use the default official domain; fill in only to pin a specific entry domain.',
        errors: {
      ...
      webLogin: {
        ...
        platformHint: {
          ...
          kimi: 'The login page is embedded via the site proxy; tokens cannot be captured automatically. After login, copy the Token JSON from local storage and paste it into the field below.',
        },
        ...
        autoCapturing: 'Automatically capturing login cookie…',
        autoCaptureSuccess: 'Login cookie auto-filled, validating',
        autoCaptureTimeout: 'Auto-capture timed out, please paste manually',
        pasteHint: 'Validation only checks the credential format; real availability is verified on first forward.',
        apply: 'Validate & apply',
        validationFailed: 'Credential validation failed: check the format and try again',
        tabs: {
          capture: 'Cookie Capture',
          auto: 'Auto Login',
        },
        autoLogin: {
          title: 'Auto-login with account & password',
          deepseekHint: 'DeepSeek web login returns the Cookie directly and auto-fills it after success.',
          zhipuKimiHint: 'Zhipu / Kimi web login requires SMS verification; the SMS channel is not connected yet. Use "Cookie Capture" to paste the login state manually.',
          emailLabel: 'Login email',
          emailPlaceholder: 'Email used to log in to the official web client',
          ...
          loginFailed: 'Auto-login failed. Check the account and password and try again.',
          smsStepTitle: 'An SMS code has been sent. Enter it to finish login.',
          smsCodeLabel: 'SMS code',
          smsCodePlaceholder: 'Enter the received SMS code',
          smsSubmit: 'Submit code',
          smsCodeRequired: 'Please enter the SMS code',
          smsNotConnected: 'SMS code login is not connected to the dispatch channel yet; auto-login cannot complete',
        },
      },
      cnProviders: {
        accountMode: {
      ...
      loginStatus: {
        active: 'Active',
        failed: 'Failed',
        failedTitle: 'Account login state failed; auto-login can be retried',
        failedTitleWithDetail: 'Account login state failed: {detail}',
        banned: 'Banned',
        bannedTitle: 'Account has been banned',
      ...
      batch: {
        ...
        deleteBannedConfirm: 'Delete the following {count} banned account(s)? This cannot be undone: {names}',
        deleteBannedNone: 'No banned accounts to delete',
        enable: 'Enable Accounts',
        disable: 'Disable Accounts',
        export: 'Export Web List',
        exportSuccess: 'Web account list exported',
        loginSuccess: 'One-click login finished: {success} succeeded, {failed} failed, {needsSms} need SMS',
        loginPartial: 'One-click login partially finished: {success} succeeded, {failed} failed, {needsSms} need SMS',
        loginFailed: 'One-click login failed',
        testSuccess: 'One-click test finished: {success} succeeded, {failed} failed',
        testPartial: 'One-click test partially finished: {success} succeeded, {failed} failed',
        testFailed: 'One-click test failed',
        deleteBannedSuccess: 'Deleted {count} banned account(s)',
        deleteBannedFailed: 'Failed to delete banned accounts',
        statusSuccess: 'Updated {count} account(s) status',
        statusPartial: 'Batch status update partially finished: {success} succeeded, {failed} failed',
        statusFailed: 'Failed to update account status in batch',
        exportFailed: 'Failed to export web account list',
        noSelection: 'Select accounts first',
        selectWebOnly: 'Please select accounts on a web (web) platform',
      },
      bulkEdit: {
      ...
      codeBuddyWizard: 'Models & Sub-accounts',
      codeBuddyWizardTitle: 'CodeBuddy Upstream Models & Sub-accounts',
      codeBuddyWizardOpen: 'Manage upstream models & sub-accounts for "{name}"',
      codeBuddyUnsyncedGuide: 'Upstream models are not synced yet. Sync the CodeBuddy upstream model catalog first, then create a sub-account for each model.',
      codeBuddySyncModels: 'Sync Upstream Models',
      codeBuddySyncing: 'Syncing upstream models…',
      codeBuddySyncFailed: 'Failed to sync upstream models: {error}',
      codeBuddySyncSuccess: 'Synced {count} upstream models',
      codeBuddyIntlUnavailable: 'This account is on the international site; model sync is unavailable on the intl endpoint (observed HTTP 500), so sub-accounts cannot be created.',
      codeBuddySelectAll: 'Select All',
      codeBuddyDeselectAll: 'Deselect All',
      codeBuddyColModel: 'Model',
      codeBuddyColContext: 'Context',
      codeBuddyColMaxOutput: 'Max Output',
      codeBuddyColPrice: 'Official Price',
      codeBuddyColPlatform: 'Target Platform',
      codeBuddyColGroup: 'Target Group',
      codeBuddyColPriority: 'Priority',
      codeBuddyColStatus: 'Shadow Status',
      codeBuddyStatusCreated: 'Created',
      codeBuddyStatusNotCreated: 'Not Created',
      codeBuddyStatusPartial: 'Created {done}/{total}',
      codeBuddyGroupUnselected: 'No group selected',
      codeBuddyAddGroup: 'Add group',
      ...
      codeBuddyParentCreditLabel: 'Parent account credits',
      codeBuddyLegacyName: 'Legacy name',
      codeBuddyLegacyNameHint: 'This shadow name carries no site segment (legacy data). You may rename it to <parent>:<site>:<model> while editing the account; renaming is optional.',
      codeBuddyBatchCreate: 'Create Sub-accounts in Bulk',
      codeBuddyCreating: 'Creating…',
      codeBuddyBatchCreateSuccess: 'Successfully created {count} sub-accounts',
      codeBuddyBatchCreatePartial: 'Creation done: {success} succeeded, {failed} failed',
      codeBuddyBatchCreateFailed: 'Bulk creation failed: {error}',
      codeBuddyNoSelection: 'Please select at least one unsynced model',
      codeBuddyGroupRequired: 'Model "{model}" requires a target group',
      codeBuddyParentBadge: 'Upstream',
      codeBuddyShadowBadge: 'Shadow',
      codeBuddyJumpParent: 'View Parent',
      codeBuddyDeleteBlocked: 'This account has {count} active sub-accounts. Delete or handle them first before removing the parent.',
      codeBuddyConfigurePriceHint: 'Shadow account pricing is configured per account or group after creation.',
      ...
      usageWindow: {
        ...
        codebuddyCreditNotProbed: 'Not probed yet',
