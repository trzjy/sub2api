export default {
    accounts: {
      ...
      webLogin: {
        ...
        iframeTitle: 'Official login page (embedded)',
        iframeHint: 'Complete the login in the embedded page below, then copy the Cookie and paste it into the input (embedded-page cookies cannot be read automatically).',
        iframeBlockedHint: 'The official login page may forbid embedding (X-Frame-Options). Click "Reload" to retry, or log in from a new window and paste the Cookie manually.',
        reload: 'Reload',
