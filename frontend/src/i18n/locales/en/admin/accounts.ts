export default {
    accounts: {
      ...
      webProviders: {
        ...
        renewalEmailLabel: 'Renewal Email',
        renewalEmailPlaceholder: 'Email used to log in to the official web client',
        renewalPasswordLabel: 'Renewal Password',
        renewalPasswordPlaceholder: 'Password used to log in to the official web client (leave empty to keep)',
        errors: {
          webCookieRequired: 'Web account is missing login credentials: complete the auto-login first',
          webKimiAccessTokenRequired: 'Kimi web accounts can only be created via SMS login (access_token is obtained by the backend)',
        },
      },
      webLogin: {
        autoLogin: {
          title: 'Auto-login with account & password',
          titleSms: 'Auto-login with phone number + SMS code',
          deepseekHint: 'DeepSeek web login returns the Cookie directly and auto-fills it after success.',
          zhipuKimiHint: 'Zhipu / Kimi web login uses phone number + SMS code: click send code, complete the verification as prompted, then submit.',
          ...
          smsSending: 'Sending…',
          smsCodeSent: 'SMS code sent, check your messages and enter it',
          ...
          challengeSectionTitle: 'Human-verification callback',
          zhipuCaptchaRidLabel: 'Shumei slider rid',
          zhipuCaptchaMd5Label: 'Graphic captcha md5',
          zhipuPhoneCodeLabel: 'Phone area code',
          zhipuPhoneCodePlaceholder: '86',
          kimiCaptchaValidateLabel: 'Yidun validate',
          smsChallengeWaiting: 'Complete the captcha in your browser, then fill the returned rid/md5 (Zhipu) or validate (Kimi) into the challenge fields above and retry',
          smsChallengeRetry: 'Challenge incomplete or timed out: retry sending the code or re-submit the SMS code',
          ...
          captchaWidgetTitle: 'Human verification',
          captchaHintZhipu: 'Slide the Shumei captcha below to verify; the SMS code sends automatically after passing.',
          captchaHintKimi: 'Click "Complete Yidun verification" to launch the captcha; the SMS code sends automatically after passing.',
          captchaLaunchKimi: 'Complete Yidun verification',
          captchaSolvedZhipu: 'Shumei slider passed, sending SMS code',
          captchaSolvedKimi: 'Yidun passed, sending SMS code',
          captchaLoadFailed: 'Captcha component failed to load; switched to manual entry',
          captchaWaitZhipu: 'Please slide the Shumei captcha to verify first',
          manualFallbackToggle: 'Captcha unavailable? Enter manually',
        },
      },
      cnProviders: {
        accountMode: {
          ...
          web: 'Web (reverse)',
          webDesc: 'Forward via official web-client login state; no quota probing.',
        },
        apiProtocol: {
          title: 'API Protocol',
          adaptive: 'Adaptive',
