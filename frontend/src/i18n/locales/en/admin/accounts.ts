    ...
    accounts: {
      ...
      webLogin: {
        autoLogin: {
          ...
          deepseekHint: 'Sign in to the DeepSeek web client with email and password; the account is created after verification.',
        ...
        register: {
          modeToggle: 'Email Registration',
          modeTogglePassword: 'Password Login',
          emailLabel: 'Registration email',
          emailPlaceholder: 'Email used to register the DeepSeek account',
          emailRequired: 'Please enter the registration email',
          emailInvalid: 'Invalid email format',
          sendCode: 'Send code',
          sendCodeSending: 'Sending…',
          codeSentHint: 'Verification email sent, check your inbox (including spam); you can resend in {secs}s',
          codeSentHintNoWindow: 'Verification email sent, check your inbox (including spam)',
          sendCodeFailed: 'Failed to send the code, please retry',
          ...
          passwordPlaceholder: 'Password for the new account',
          passwordRequired: 'Please enter the registration password',
          passwordRuleHint: 'The password must be at least 8 characters and contain both letters and digits',
          passwordWeak: 'Password too weak: at least 8 characters with both letters and digits required',
          submit: 'Register & Create Account',
          submitting: 'Registering…',
          registerFailed: 'Registration failed, please retry',
          errorRecaptcha: 'Upstream requires human verification; use the password login entry or try again later',
          errorEmailDomain: 'This email domain is not supported; please use a different email',
          errorRegisteredUsePasswordLogin: 'The account has been registered with DeepSeek. Use the email + password in the "Password Login" entry to finish creating it.',
        },
      },
      cnProviders: {
        accountMode: {
