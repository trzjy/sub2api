export default {
    ...
    users: {
      ...
      subscriptionFilter: 'Active Subscription',
    ...
    groups: {
      ...
      form: {
        ...
        concurrencyLimit: 'Subscription Group Concurrency Limit',
        concurrencyLimitPlaceholder: '0 = unlimited',
        concurrencyLimitHint: 'Subscription groups only: caps the number of concurrent requests per individual user (not the group total); 0 = unlimited',
