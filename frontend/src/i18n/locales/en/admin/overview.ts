export default {
    ...
    groups: {
      ...
      modelsList: {
        ...
        hint: 'Toggle + selection below = the site-declared model list: used by /v1/models, the model pricing page (plaza) and the uncovered-model scan; whitelisted calls and routing unchanged.',
