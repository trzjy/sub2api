...
const flagXianyuDelivery = () => adminSettingsStore.xianyuDeliveryEnabled
...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    { path: '/model-plaza', label: t('nav.modelPricing'), icon: PriceTagIcon },
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/promo-intel', label: t('nav.promoIntel'), icon: GiftIcon, hideInSimpleMode: true },
    ...
    { path: '/admin/pricing', label: t('nav.pricing'), icon: PriceTagIcon, hideInSimpleMode: true },
