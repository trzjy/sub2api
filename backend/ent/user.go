...
// was not loaded in eager-loading.
func (e UserEdges) WelfareBalancesOrErr() ([]*WelfareBalance, error) {
	if e.loadedTypes[13] {
...
// QueryWelfareBalances queries the "welfare_balances" edge of the User entity.
func (_m *User) QueryWelfareBalances() *WelfareBalanceQuery {
	return NewUserClient(_m.config).QueryWelfareBalances(_m)
}
