...
func init() {
	...
	// groupDescConcurrency is the schema descriptor for concurrency field.
	groupDescConcurrency := groupFields[57].Descriptor()
	// group.DefaultConcurrency holds the default value on creation for the concurrency field.
	group.DefaultConcurrency = groupDescConcurrency.Default.(int)
	...
	subscriptionplan.DefaultPriceCny = subscriptionplanDescPriceCny.Default.(float64)
	// subscriptionplanDescOriginalPriceCny is the schema descriptor for original_price_cny field.
	subscriptionplanDescOriginalPriceCny := subscriptionplanFields[6].Descriptor()
	// subscriptionplan.DefaultOriginalPriceCny holds the default value on creation for the original_price_cny field.
	subscriptionplan.DefaultOriginalPriceCny = subscriptionplanDescOriginalPriceCny.Default.(float64)
