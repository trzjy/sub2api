...
func (s *OpenAIGatewayService) handleWebZhipuStreamingResponse(
	...
	for scanner.Scan() {
		...
		if err := writeWebZhipuClientChunk(c, webZhipuClientChunkEnvelope(responseID, originalModel, gin.H{"content": view.Content}, "", nil)); err != nil {
			return nil, err
		}
	}
	...
	if err := writeWebZhipuClientChunk(c, webZhipuClientChunkEnvelope(responseID, originalModel, gin.H{}, finishReason, usage)); err != nil {
		return nil, err
	}
