...
func (s *SettingService) InitializeDefaultSettings(ctx context.Context) error {
	...
	defaults := map[string]string{
		...
		SettingKeyConcurrencyLimitMessage:                   infraerrors.ConcurrencyDefaultTemplate,
		SettingKeySiteLogo:                                  "",
		SettingKeySupportQRCodeURL:                          "",
...
func (s *SettingService) parseSettings(settings map[string]string) *SystemSettings {
	...
	result := &SystemSettings{
		...
		RegistrationEmailSuffixBlacklist:       ParseRegistrationEmailSuffixWhitelist(settings[SettingKeyRegistrationEmailSuffixBlacklist]),
		...
		ConcurrencyLimitMessage:                settings[SettingKeyConcurrencyLimitMessage],
		SiteLogo:                               settings[SettingKeySiteLogo],
		SiteSubtitle:                           s.getStringOrDefault(settings, SettingKeySiteSubtitle, "Subscription to API Conversion Platform"),
		APIBaseURL:                             settings[SettingKeyAPIBaseURL],
		ContactInfo:                            settings[SettingKeyContactInfo],
		SupportQRCodeURL:                       settings[SettingKeySupportQRCodeURL],
	...
	result.XianyuDeliveryEnabled = settings[SettingKeyXianyuDeliveryEnabled] == "true"
