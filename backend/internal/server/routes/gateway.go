...
func RegisterGatewayRoutes(
	...
	isOpenAIResponsesCompatibleGatewayPlatform := func(c *gin.Context) bool {
		...
		case service.PlatformOpenAI, service.PlatformGrok,
			service.PlatformKimi, service.PlatformZhipu, service.PlatformDeepseek, service.PlatformOther:
			// 国产 OpenAI 兼容供应商（kimi/zhipu/deepseek）、通用 other 与 openai/grok 一样经 OpenAI 网关转发。
			return true
		default:
			return false
		}
	...
	countTokensHandler := func(c *gin.Context) {
		switch getGroupPlatform(c) {
		case service.PlatformOpenAI, service.PlatformKimi, service.PlatformZhipu, service.PlatformDeepseek, service.PlatformOther:
