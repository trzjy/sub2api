...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.POST("/validate-web-credentials", h.Admin.Account.ValidateWebCredentials)
...
func registerRedeemCodeRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	codes := admin.Group("/redeem-codes")
	{
		...
		codes.GET("/values", h.Admin.Redeem.ListValues)
		codes.GET("/export", h.Admin.Redeem.Export)
		codes.GET("/:id", h.Admin.Redeem.GetByID)
		codes.POST("/create-and-redeem", h.Admin.Redeem.CreateAndRedeem)
		codes.POST("/generate", h.Admin.Redeem.Generate)
		codes.GET("/welfare-batches", h.Admin.Redeem.ListWelfareBatches)
		codes.POST("/welfare-batches", h.Admin.Redeem.GenerateWelfareBatch)
		codes.GET("/welfare-batches/:id/codes", h.Admin.Redeem.ListWelfareBatchCodes)
