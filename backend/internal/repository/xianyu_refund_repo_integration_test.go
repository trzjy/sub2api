...
func realClawbackService() *service.RedeemService {
	...
	return service.NewRedeemService(nil, userRepo, nil, nil, nil, integrationEntClient, nil, nil, nil)
}
...
func TestXianyuRefundSubscriptionClawbackLocksSubscriptionRow(t *testing.T) {
	...
	clawSvc := service.NewRedeemService(nil, userRepo, subSvc, nil, nil, integrationEntClient, nil, nil, nil)
