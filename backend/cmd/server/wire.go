...
type Application struct {
	Server              *http.Server
	WebLoginProxyServer *server.WebLoginProxyServer
...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	wire.Build(
		...
		// Application struct
		wire.Struct(new(Application), "Server", "WebLoginProxyServer", "PromptAudit", "PluginManager", "Cleanup"),
	)
	return nil, nil
}
...
func provideCleanup(
	...
	promoIntelService *service.PromoIntelService,
	...
	return func() {
		...
		parallelSteps := []cleanupStep{
			...
			{"PromoIntelService", func() error {
				if promoIntelService != nil {
					promoIntelService.Stop()
				}
				return nil
			}},
